...
<template>
    <section class="moduleInfo">
        ...
        <div class="mainInfo">
            ...
            <el-tag type="info" effect="plain" :color="colors[Math.floor(Math.random() * 9)]">Path of the module:<br><br>{{ path }}</el-tag>
            <el-tag type="info" :color="colors[Math.floor(Math.random() * 9)]">Description of the module :<br><br>{{ description }}</el-tag>
        </div>
        <div class="dependencies">
            <GraphModule module-name="Dependencies :" :modules-arr="dependenciesArr" />
        </div>
