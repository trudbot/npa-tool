...
<template>
    <div class="module-info">
        ...
        <div class="dependencies">
            ...
            <GraphModule module-name="Be Relied :" :modules-arr="selectedPackageStore.dependencyList" />
        </div>
        <el-button @click="showDependencies" type="primary"  round plain>Dependencies</el-button>
        <el-button @click="showBeRelied" type="primary"  round plain>Be dependent</el-button>
    </div>
</template>
...
.module-info {
    .main-info {
        padding: 2% 2% 1% 2%;
        border-bottom: 2px solid rgb(190,233,232);
